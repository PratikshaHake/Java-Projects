...
public class Client implements ActionListener
{
    ...
    Client()
    {
        ...
        JLabel name=new JLabel("Pratiksha");
    ...
    public static void main(String[] arg)
    {
        ...
        try
        {
            ...
            DataInputStream din=new DataInputStream(sobj.getInputStream());
            dout=new DataOutputStream(sobj.getOutputStream());
            while(true)
             {
